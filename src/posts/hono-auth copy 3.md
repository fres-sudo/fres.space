---
title: How to spin up a Hono Authentication System
slug: hono-auth
description: In this article I'm will try my best to explain to you about the creation from the ground up of a complete authentication system for your next successful application.
date: '2024-11-03'
categories:
  - text: hono
    color: orange
  - text: auth
    color: red
published: true
image: '' # Add image URL here if available
---
...
Even if Drizzle is a *fast* ORM, it will require a small setup, nothing too crazy, don't worry. For more detailed introduction to setup Drizzle ORM I higly suggest you to check out their official [documentation](https://orm.drizzle.team/docs/get-started/postgresql-new) that is very great.
...
export class MailerService {
  ...
  private async send({ to, subject, html }: SendMail) {
    ...
    log.info(nodemailer.getTestMessageUrl(message));
  }
